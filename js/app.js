(() => {
    ...
    let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0, timeOut = 600) => {
    ...
    iconPass.addEventListener("click", (() => {
        if (inputPass.getAttribute("type") === "password") inputPass.setAttribute("type", "text"); else inputPass.setAttribute("type", "password");
    }));
    ...
    iconPassReg.addEventListener("click", (() => {
        if (inputPassReg.getAttribute("type") === "password") inputPassReg.setAttribute("type", "text"); else inputPassReg.setAttribute("type", "password");
    }));
